...
func (mods *Modules) MulChain() MulChain {
	return mods.multichainlist
}
...
func (b *Builder) Register(mods ...interface{}) { //nolint:gocyclo
	for _, module := range mods {
		...
		if m, ok := module.(MulChain); ok {
			b.mods.multichainlist = m
		}
