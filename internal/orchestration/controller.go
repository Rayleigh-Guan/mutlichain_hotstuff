...
func (e *Experiment) startReplicas(cfg *orchestrationpb.ReplicaConfiguration) (err error) {
	...
	for host, worker := range e.Hosts {
		// fmt.Println("id: 1 address: ", cfg.GetReplicas()[1].Address, " replica port: ", cfg.GetReplicas()[1].ReplicaPort, " client port: ", cfg.GetReplicas()[1].ClientPort)
		// fmt.Println("id: 2 address: ", cfg.GetReplicas()[2].Address, " replica port: ", cfg.GetReplicas()[2].ReplicaPort, " client port: ", cfg.GetReplicas()[2].ClientPort)
		// fmt.Println("id: 3 address: ", cfg.GetReplicas()[3].Address, " replica port: ", cfg.GetReplicas()[3].ReplicaPort, " client port: ", cfg.GetReplicas()[3].ClientPort)
		// fmt.Println("id: 4 address: ", cfg.GetReplicas()[4].Address, " replica port: ", cfg.GetReplicas()[4].ReplicaPort, " client port: ", cfg.GetReplicas()[4].ClientPort)
